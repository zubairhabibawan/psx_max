    ...
    <VCard>
      ...
      >
        ...
        <template #item.order="{ item }">
          <RouterLink
            :to="{ name: 'sale-return-detail-id', params: { id: item.order } }"
          ...
          <div class="d-flex align-center">
            ...
            <div class="d-flex flex-column">
              <div class="text-body-1 font-weight-medium">
                <RouterLink
                  :to="{ name: 'sale-customer-detail-id', params: { id: 478426 } }"
                  class="font-weight-medium"
                >
                  {{ item.customer }}
                </RouterLink>
          ...
          <IconBtn>
            ...
            <VMenu activator="parent">
              <VList>
                <VListItem
                  value="view"
                  :to="{ name: 'purchase-return-detail-id', params: { id: item.order } }"
                >
                  View
                </VListItem>
                <VListItem
